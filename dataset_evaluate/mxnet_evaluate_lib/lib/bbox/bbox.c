...
static const char __pyx_k_usr_local_app_unskychen_dmc_Def[] = "/usr/local/app/unskychen/dmc/Deformable-ConvNets/lib/bbox/bbox.pyx";
 ...
 */
  ...
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(2, 0, 11, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_usr_local_app_unskychen_dmc_Def, __pyx_n_s_bbox_overlaps_cython, 17, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
