...
txt_list_path = glob.glob('label/*.txt')
txt_list = []
...
num_trainval = random.sample(txt_list, math.floor(len(txt_list)*9/10.0)) # ���޸İٷֱ�
num_trainval.sort()
print(num_trainval, end = '\n\n')

num_train = random.sample(num_trainval,math.floor(len(num_trainval)*8/9.0)) # ���޸İٷֱ�
num_train.sort()
print(num_train, end = '\n\n')
...
category_name = ['Truck', 'Person_sitting', 'Van', 'Car', 'Pedestrian', 'Cyclist', 'Tram']

# ѭ��дtrainvl train val test
