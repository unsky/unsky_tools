...
with open('res/comp4_det_test_Person_sitting.txt', 'r') as f:
     lines = f.readlines()   
for index,line in enumerate(lines):
     line = line.split()
     st =[0,0,0,0,0]
     ...
     if h>=h_threshold:
         if st[4]>threshold_score:
             out_file = open('uptxt/%s.txt'%(str(line[0])), 'a')
             out_file.write("person_sitting -1.00 -1 -1 " + str(st[0]) + " " + str(st[1]) + " " + str(st[2])+ " "+ str(st[3])+ " -1.00 -1.00 -1.00 -1000.00 -1000.00 -1000.00 -1 "+ str(st[4]) + "\n")
...
with open('res/comp4_det_test_Van.txt', 'r') as f:
     lines = f.readlines()   
for index,line in enumerate(lines):
     line = line.split()
     st =[0,0,0,0,0]
     ...
     if h>=h_threshold:
         if st[4]>threshold_score :
             out_file = open('uptxt/%s.txt'%(str(line[0])), 'a')
             out_file.write("van -1.00 -1 -1 " + str(st[0]) + " " + str(st[1]) + " " + str(st[2])+ " "+ str(st[3])+ " -1.00 -1.00 -1.00 -1000.00 -1000.00 -1000.00 -1 "+ str(st[4]) + "\n")
